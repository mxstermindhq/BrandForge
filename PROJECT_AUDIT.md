...
- [x] AuthWall component with blur preview
- [x] Applied to: Brief Generator, Proposal Writer, Marketplace, Work Feed, Squad Builder, Leaderboard
- [x] Social login buttons (Google, LinkedIn, X) integrated
- [x] Notification bell moved to sidebar

### Profile & Feed
- [x] Enhanced PublicProfileClient with tabs (About, Services, Reviews, Portfolio)
- [x] OG meta tags & Twitter Cards for SEO
- [x] Work Feed with composer, filters, and item cards
- [x] Feed API endpoints

### Integrations
- [x] AvailabilityToggle in settings and profile
- [x] CollabSquadBuilder in /squads page
- [x] PortfolioUploader in profile
- [x] OpenToOffersToggle in profile
- [x] ReferralSystem in settings
- [x] SocialLoginButtons in login page

### Content & Legal
- [x] Terms page rewritten with marketplace-specific content
- [x] Privacy page updated with data protection policies
- [x] Replaced brandforge.ai → brandforge.gg everywhere
- [x] Deleted unused components: TopNavBar, HeaderToolbar, SidebarToolbar, journey/, projects/

### AI Features (Groq API)
- [x] Brief Generator with AI (POST /api/ai/generate?tool=brief)
- [x] Proposal Writer with AI (POST /api/ai/generate?tool=proposal)
- [x] AI Career Assistant (POST /api/ai/career-advice)
- [x] Backend supports Groq, OpenAI, Anthropic, and other providers
