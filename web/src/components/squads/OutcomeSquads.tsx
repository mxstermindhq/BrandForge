...
export function OutcomeSquads() {
  ...
  return (
    <main className="min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      {/* Tabs and Content - Wrapped with AuthWall for guests */}
      <AuthWall
        feature="Squad Builder"
        ctaText="Sign in to form squads and collaborate"
        preview={
          <div className="max-w-6xl mx-auto px-6 py-4">
            <div className="flex items-center gap-1 p-1 bg-muted/50 border border-border rounded-xl w-fit mb-6">
              <button className="flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium bg-primary text-primary-foreground">
                <Users size={14}/> My Squads
              </button>
              <button className="flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium text-muted-foreground">
                <Search size={14}/> Find
              </button>
              <button className="flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium text-muted-foreground">
                <Plus size={14}/> Create
            ...
            {/* Preview of squad concept */}
            <div className="p-5 rounded-xl bg-zinc-900/50 border border-zinc-800 opacity-60">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <div className="flex items-center gap-2 mb-1">
                    <h3 className="font-semibold text-lg">Example Squad</h3>
                  ...
                  <p className="text-sm text-muted-foreground">This is a preview of what squads look like. Sign in to create and join squads.</p>
                </div>
              </div>
            </div>
          </div>
