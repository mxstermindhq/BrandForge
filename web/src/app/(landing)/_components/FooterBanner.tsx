...
export function FooterBanner() {
  return (
    <section className="relative overflow-hidden border-t border-[#C9A84C]/25 bg-[#0A0F1E] px-4 py-16 sm:px-6 lg:px-8">
      <svg
        ...
        aria-hidden
      >
        <path d="M100 12l17 34 38 2-30 23 10 37-35-18-35 18 10-37-30-23 38-2 17-34z" stroke="#C9A84C" strokeWidth="2" />
        <path d="M100 43l9 18 20 1-16 12 5 20-18-9-18 9 5-20-16-12 20-1 9-18z" stroke="#C9A84C" strokeWidth="2" />
      </svg>
