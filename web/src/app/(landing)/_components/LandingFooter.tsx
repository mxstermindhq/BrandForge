...
const socialLinks = [
  ...
  { 
    ...
    href: "https://github.com/brandforge", 
    label: "GitHub" 
  },
];
  ...
  return (
    <footer className="bg-surface-container-low border-t border-outline-variant">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 lg:gap-12">
          ...
          <div className="col-span-2 md:col-span-4 lg:col-span-1 mb-8 lg:mb-0">
            ...
            <div className="flex items-center gap-4">
              ...
              <a href="mailto:hello@brandforge.gg" className="text-on-surface-variant hover:text-on-surface transition-colors">hello@brandforge.gg</a>
            </div>
          </div>
        ...
        {/* Bottom Bar */}
        <div className="mt-12 pt-8 border-t border-outline-variant/50 flex flex-col md:flex-row items-center justify-between gap-4">
