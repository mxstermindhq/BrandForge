  ...
  return (
    <div className="bg-background text-on-surface flex min-h-screen flex-col items-center justify-center px-6 py-16">
      <div className="max-w-md text-center">
        ...
        <h1 className="font-display mt-3 text-2xl font-bold tracking-tight">Payment submitted</h1>
        <p className="text-on-surface-variant mt-3 text-sm font-light leading-relaxed">
          Your checkout session was completed. Escrow updates when the webhook confirms — open your deal room chat in a
          moment to see the latest embeds.
        </p>
        {sid ? (
          <p className="text-on-surface-variant/50 mt-4 break-all font-mono text-[10px]">{sid}</p>
        ) : null}
