...
const nextConfig = {
  ...
  async redirects() {
    ...
    return [
      ...
      { source: "/marketplace/:category", destination: "/?term=starter&category=:category", permanent: true },
      ...
      { source: "/product/discord-nitro-branding", destination: "/product/logo-social-kit-express", permanent: true },
      { source: "/product/brand-kit-pro", destination: "/product/personal-brand-growth-kit", permanent: true },
      { source: "/product/landing-page-build", destination: "/product/high-converting-landing-page", permanent: true },
      { source: "/product/creator-growth-pack", destination: "/product/viral-content-strategy-pack", permanent: true },
      { source: "/product/automation-workflow", destination: "/product/ai-automation-business-system", permanent: true },
      { source: "/product/content-system-monthly", destination: "/product/content-repurpose-engine", permanent: true },
      { source: "/product/notion-template-hub", destination: "/product/digital-product-store-setup", permanent: true },
      { source: "/product/ai-agent-rental", destination: "/product/ai-chatbot-businesses", permanent: true },
      { source: "/product/landing-page-template", destination: "/product/high-converting-landing-page", permanent: true },
