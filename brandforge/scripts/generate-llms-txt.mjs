...
const lines = [
  ...
  "- mxstermind.com: Founder Operating System — monetization, ops, and growth systems beyond package tiers",
  ...
  "- Above tier 5 / operating layer: mxstermind.com (Founder OS)",
  "",
  "## Brand guide",
