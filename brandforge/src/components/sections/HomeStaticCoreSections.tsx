...
import { PACKAGES_LIST, HERO_STATS, SERVICES, VOUCHES } from "@/content/home";
  ...
  return (
    ...
    >
      ...
      <div className="content-wrap relative">
        ...
        <dl className="mt-14 grid grid-cols-2 gap-4 sm:grid-cols-4" aria-label="BrandForge track record">
          {HERO_STATS.map((stat) => (
