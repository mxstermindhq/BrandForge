      ...
      <nav className="content-wrap flex items-center justify-between h-14 sm:h-16">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          <a
            ...
            className="inline-flex items-center gap-1.5 rounded-md bg-discord px-3 sm:px-4 py-2 text-[11px] sm:text-xs font-bold text-white transition-opacity hover:opacity-90"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-1.5 rounded-md bg-telegram px-3 sm:px-4 py-2 text-[11px] sm:text-xs font-bold text-white transition-opacity hover:opacity-90"
          >
...
function SiteFooterSimple() {
  return (
    <footer className="relative z-10 border-t border-b1/40 py-8">
